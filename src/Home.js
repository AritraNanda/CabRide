    ...
    <div>
        ...
        <div className="home-content grid-layout">
          ...
          <div className="contact-form bg-image">
            ...
            <div class="form-fields">
              <input type="text" placeholder="Name" className='homeinp'/>
              <input type="tel" placeholder="Phone" className='homeinp'/>
              <input type="date" placeholder="Date" className='homeinp'/>
              <input type="time" placeholder="Time" className='homeinp' />
              <input type="text" placeholder="Pickup Location" className='homeinp'/>
              <input type="text" placeholder="Drop Location" className='homeinp'/>
            </div>
        ...
        <div className="inner-tariff">
          ...
          <div className="tariff-container">
            <div className="inner-box3 inner">
              ...
              <Link to="/requestcab"><button>Request SUV</button></Link> 
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="contact-container">
        <div className="contact-content">
          ...
          <a href="mailto:aritra.nanda2022@vitstudent.ac.in" className="contact-link">
            Email Us
          </a>
